...
public class InviteHandler extends DialogMethodHandler
    ...
    public static final String RTP_HOST_ADDRESS = "10.18.110.4";
    public static final int RTP_PORT_MIN = 16384;
    public static final int RTP_PORT_MAX = 32767;
...
//        }
        ...
        if (sipResponse.getStatusCode() == 100 /* Trying */) { // instead of RFC3261.CODE_180_RINGING
            logger.info("Starting early media: " + sipResponse);

            final String localAddress = userAgent.getConfig().getLocalInetAddress().getHostAddress();
            final String remoteAddress = RTP_HOST_ADDRESS;
            int remotePort = randomUdpPort();
...
//        userAgent.getMediaManager().successResponseReceived(localAddress, remoteAddress, remotePort, codec);
    ...
    public int randomUdpPort() {
        final Random random = new Random();
        return random.nextInt(RTP_PORT_MAX - RTP_PORT_MIN) + RTP_PORT_MIN;
    }
